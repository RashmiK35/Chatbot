...
export default function List() {
    ...
    const getOverallRiskScore = (overall_risk_score) => {
        ...
        return (
            <span
                ...
                style={{ opacity: "0.7", textCombineUpright: "revert" }}
            >
    ...
    <div className='main' style={{marginLeft:"4%", marginRight:"30px"}}>
            <div className='text-md-right' style={{textAlign:"right" , paddingBottom:"5px" }} variant="contained">
                ...
                >
                    <button style={{border:"2px solid skyblue", borderRadius:"5px", backgroundColor:"blue",color:"white"}} value={filteredRecords}><CiExport /></button>
                </CSVLink>
            </div>
        <div>
            <div className="row" >
                                    ...
                                    {records.length > 0 ? (
                                        getFilteredRecords().map((row, key)=>(
                                                <tr key={key} className='table-bordered'>
                                                    ...
                                                    <td>
                                                        <Link to={`/product/View/${row.id}`} className='btn-success '>
                                                            {/* <CgDetailsMore style={{fontSize:15}}/> */}
                                                            <GrView style={{size:"50px"}}/>
                                                            {/* <strong style={{fontSize:"5"}}>View</strong> */}
                                                        </Link>
                                                    </td>
                                                </tr>
                                            ))
            ...
            <div className='justify-content-md-center justify-content-center align-items-center pe-2 row' style={{marginTop:"10px", marginBottom:"10px"}}>
                ...
                <div className='col-md-auto col'>
                    ...
                    <button type='button' className='btn btn-info' onClick={handleGoToPage} style={{margin:"20px"}}> Go </button>
                </div>
                <div className='col-md-auto col'>
